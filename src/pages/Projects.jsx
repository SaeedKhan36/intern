                    ...
                    <div className="flex items-center gap-3 mb-1">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-surface-500 mt-1">
                                Manage all construction projects across sites
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-6">
                    ...
                    <div className="relative flex-1 max-w-md">
                        ...
                        <input
                            ...
                            className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-surface-200 bg-white shadow-sm text-sm
                placeholder:text-surface-400 focus:outline-none focus:ring-1 focus:ring-surface-900 focus:border-surface-900
                transition-colors duration-200 hover:border-surface-300"
                        />
                    </div>
